...
{
	public static @JsonAutowired(value=Account.class, filepath="D:/project/jmart/src/main/java/com/AbdulMalikKarimAJmartMR/account.json") JsonTable<Account> accountTable;
