...
public class ProductController implements BasicGetController<Product>{
    public static @JsonAutowired(value= Product.class, filepath="D:/project/jmart/src/main/java/com/AbdulMalikKarimAJmartMR/randomProductList.json") JsonTable<Product> productTable;
